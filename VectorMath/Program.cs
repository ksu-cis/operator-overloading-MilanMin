    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            */
            ...
            Console.WriteLine($"Vecot comparison: {one == two}");



            Console.WriteLine($"Vecot comparison: {one == new Vector3(5,4,3)}");
            ...
            if (zero)
            {
                Console.WriteLine("Vector zero is not zero");
            }
            else
            {
                Console.WriteLine("Vector zero is zero");
            }
        }
    }
}
